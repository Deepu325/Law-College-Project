...
const RegistrationPage = () => {
    ...
    return (
        <div className="min-h-screen bg-bg-exam py-12">
            <div className="container mx-auto px-4 max-w-2xl">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-text-body">Please fill in your details to begin the exam</p>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            <label htmlFor="qualification" className="block text-sm font-semibold text-text-dark mb-2">
                                Qualification <span className="text-error-red">*</span>
                            </label>
                            <input
                                type="text"
                                id="qualification"
                                ...
                                placeholder="e.g., B.A., B.Com, B.Sc."
                            />
